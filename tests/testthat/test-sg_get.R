...
sg_get_fun <- function(api_operation, query = NULL, type = NULL) {
  desuctools::sg_get(
...
test_that("OperationData works en sg_get", {
  output_json <- sg_get_fun(
    api_operation = "OperationData",
...
test_that("Lista de Studio Users mayor a 0. output csv", {
  output_csv <- sg_get_fun(
    api_operation = "Admin/GetStudioUsers",
    type = "text/csv"
  )
